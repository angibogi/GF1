...
export default function Services() {
  return (
    ...
    <section className=" grid gap-8 md:grid-cols-2 lg:grid-cols-4  container mx-auto px-4">
        <div className=" mx-auto text-center my-5 lg:w-[350px]  w-[400px]  p-5">
           <div className=" bg-second border-2 border-main md:h-[500px] items-center ">
                <img className="w-[20%] md:w-[30%] h-50 m-auto mt-5" src={cart} alt="" />
                <h2 className="font-bold my-5">E-COMMERCE</h2>
                <p className="w-[60%] m-auto mb-10">All’interno di questa sezione potrete acquistare comodamente i nostri prodotti. Accettiamo pagamenti sicuri e offriamo spedizioni rapide.
        ...
        <div className="mx-auto text-center my-5 lg:w-[350px] w-[400px] p-5">
           <div className=" bg-second border-2 border-main md:h-[500px] items-center ">
            ...
            <p className="w-[60%] m-auto mb-10">Tel. 0585 53703 <br /> Fax. 0585 857667 <br /><br /> Per effettuare ordini o richiedere informazioni è possibile contattare anche il numero 3481419281 con il seguente orario: <br /> 8:30 – 12:30 <br /> 15:30 – 18.30</p>
            </div>
        </div>
        <div className="mx-auto text-center my-5 lg:w-[350px] w-[400px] p-5">
           <div className=" bg-second border-2 border-main md:h-[500px] items-center ">
                ...
                <p className="w-[60%] m-auto mb-10">I nostri agenti di zona sono essenziali per la nostra attività.
        ...
        <div className="mx-auto text-center my-5 lg:w-[350px] w-[400px] p-5">
           <div className=" bg-second border-2 border-main md:h-[500px] items-center ">
                ...
                <p className="w-[60%] m-auto mb-10">Con le nostre consegne rapide e l’ottimo servizio, potrai goderti i nostri prodotti freschi nel giro di pochissimo tempo. Inoltre, offriamo anche consegne in giornata per garantire la massima convenienza. Scegliere noi significa ricevere il meglio!</p>
            </div>
        </div>
    </section>
